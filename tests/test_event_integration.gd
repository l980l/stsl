...
func test_remove_random_card_handles_scattered_deck() -> void:
	...
	var c1 := CardRes.new(); c1.owner_id = "napoleon"; dm.hand.append(c1)
	var c2 := CardRes.new(); c2.owner_id = "napoleon"; dm.discard_pile.append(c2)
	var c3 := CardRes.new(); c3.owner_id = "napoleon"; dm.exhaust_pile.append(c3)
