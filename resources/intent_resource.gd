...
enum ActionType { ATTACK, BUFF, DEBUFF, SPECIAL, PREPARE, HEAL_ALLY, BUFF_ALLY, COUNTER_PREPARE, MARK_TARGET, SACRIFICE, WARD, SUMMON, MIMIC, CHARGE_UP, DISPEL, FORM_SWITCH, CHANGE_AFFINITY, INFLICT_WEAKNESS }
