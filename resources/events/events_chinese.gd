...
static func _eight_immortals_feast() -> Resource:
	...
	var cc: Resource = ChoiceRes.new(); cc.label = "event.chinese.eight_immortals_feast.choice_3"
...
static func _celestial_market() -> Resource:
	...
	var cc: Resource = ChoiceRes.new(); cc.label = "event.chinese.celestial_market.choice_3"
	cc.effect_type = ChoiceRes.EffectType.NONE
	e.choices = [ca, cb, cc]; return e
...
static func _dragon_king_invitation() -> Resource:
	...
	var cc: Resource = ChoiceRes.new(); cc.label = "event.chinese.dragon_king_invitation.choice_3"
	cc.effect_type = ChoiceRes.EffectType.NONE
	e.choices = [ca, cb, cc]; return e
...
static func _shennong_herbs() -> Resource:
	...
	var cc: Resource = ChoiceRes.new(); cc.label = "event.chinese.shennong_herbs.choice_3"
	cc.effect_type = ChoiceRes.EffectType.NONE
	e.choices = [ca, cb, cc]; return e
