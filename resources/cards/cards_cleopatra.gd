...
static func _isis_blessing() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.isis_blessing.name"; c.owner_id = "cleopatra"
	c.cost = 0; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "idle"
	c.archetype = "card.cleopatra.isis_blessing.archetype"
	var ea := EffRes.new()
...
static func _desert_poison_dance() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.desert_poison_dance.name"; c.owner_id = "cleopatra"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "card.cleopatra.desert_poison_dance.archetype"
	var ea := EffRes.new()
	ea.effect_type = EffRes.EffectType.DAMAGE
...
static func _poison_fog_spray() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.poison_fog_spray.name"; c.owner_id = "cleopatra"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "attack"
	c.archetype = "card.cleopatra.poison_fog_spray.archetype"
	var ea := EffRes.new()
	ea.effect_type = EffRes.EffectType.DAMAGE
...
static func _nile_blessing() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.nile_blessing.name"; c.owner_id = "cleopatra"
	c.cost = 0; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "idle"
	c.archetype = "card.cleopatra.nile_blessing.archetype"
	var e := EffRes.new()
...
static func _double_fang() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.double_fang.name"; c.owner_id = "cleopatra"
	c.cost = 2; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "attack"
	c.archetype = "card.cleopatra.double_fang.archetype"
	var ea := EffRes.new()
	ea.effect_type = EffRes.EffectType.DAMAGE
	ea.value = 80; ea.base_value = 80; ea.target = "SINGLE"
	var eb := EffRes.new()
...
static func _nile_flow() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.nile_flow.name"; c.owner_id = "cleopatra"
	c.cost = 0; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "idle"
	c.archetype = "card.cleopatra.nile_flow.archetype"
	var ea := EffRes.new()
...
static func _snake_poison_dance() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.snake_poison_dance.name"; c.owner_id = "cleopatra"
	c.cost = 2; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "card.cleopatra.snake_poison_dance.archetype"
	var e := EffRes.new()
	e.effect_type = EffRes.EffectType.APPLY_STATUS
...
static func _curse_crossroads() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.curse_crossroads.name"; c.owner_id = "cleopatra"
	c.cost = 2; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "idle"
	c.archetype = "card.cleopatra.curse_crossroads.archetype"
	var ea := EffRes.new()
	ea.effect_type = EffRes.EffectType.APPLY_STATUS
...
static func _sekhmet_curse() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "card.cleopatra.sekhmet_curse.name"; c.owner_id = "cleopatra"
	c.cost = 3; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.DIVINE; c.play_animation = "idle"
	c.archetype = "card.cleopatra.sekhmet_curse.archetype"
	var e1 := EffRes.new()
	e1.effect_type = EffRes.EffectType.APPLY_STATUS
