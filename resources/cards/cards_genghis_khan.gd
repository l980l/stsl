...
static func _light_cavalry_sprint() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "경기병 질주"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "attack"
	c.archetype = "기동"
	var ea := EffRes.new()
...
static func _swift_raid() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "급습"; c.owner_id = "genghis_khan"
	c.cost = 0; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "attack"
	c.archetype = "기동"
	var e := EffRes.new()
...
static func _loot() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "노획"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "idle"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _victory_spoils() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "승리의 전리품"; c.owner_id = "genghis_khan"
	c.cost = 0; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "idle"
	c.archetype = "약탈"
	var e := EffRes.new()
...
static func _cavalry_assault() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "기병대 습격"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var e := EffRes.new()
...
static func _rear_disruption() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "후방 교란"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.COMMON; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var ea := EffRes.new()
...
static func _cavalry_crossing() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "기마 도하"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "idle"
	c.archetype = "기동"
	var ea := EffRes.new()
...
static func _lightning_sprint() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "낙뢰 질주"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "기동"
	var ea := EffRes.new()
...
static func _execution_ground() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "처형대"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "약탈"
	var e := EffRes.new()
...
static func _spoils_distribution() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "전리품 배분"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "idle"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _plunder_flame() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "약탈의 불길"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _rapid_fire() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "연사"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var e := EffRes.new()
...
static func _wind_legion() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "바람의 군단"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var ea := EffRes.new()
...
static func _cavalry_encirclement() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "기병 포위망"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var ea := EffRes.new()
...
static func _iron_breakthrough() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "무간 돌파"; c.owner_id = "genghis_khan"
	c.cost = 2; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var ea := EffRes.new()
...
static func _desert_cavalry() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "사막 기마"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "기동"
	var e := EffRes.new()
...
static func _territory_expansion() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "영토 확장"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "idle"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _red_horizon() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "붉은 지평선"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _genghis_territory() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "징기스의 영토"; c.owner_id = "genghis_khan"
	c.cost = 2; c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "idle"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _submission() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "굴복"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _poison_arrow_rain() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "독 화살비"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var ea := EffRes.new()
...
static func _thousand_mile_army() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "천리 원정군"; c.owner_id = "genghis_khan"
	c.cost = 2; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var e := EffRes.new()
...
static func _steppe_terror() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "대초원의 위협"; c.owner_id = "genghis_khan"
	c.cost = 1; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "몽골 기병"
	var ea := EffRes.new()
...
static func _war_tribute() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "전쟁의 대가"; c.owner_id = "genghis_khan"
	c.cost = 2; c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.RARE; c.play_animation = "attack"
	c.archetype = "약탈"
	var ea := EffRes.new()
...
static func _great_steppe_siege() -> Resource:
	...
	var c := CardRes.new()
	c.card_name = "대초원의 포위"; c.owner_id = "genghis_khan"
	c.cost = 2; c.card_type = CardRes.CardType.ATTACK
