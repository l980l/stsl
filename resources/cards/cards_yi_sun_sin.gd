...
static func _iron_armor() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.iron_armor.name"; c.owner_id = "yi_sun_sin"; c.cost = 2
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.iron_armor.archetype"
	var e := EffRes.new()
...
static func _crane_wing() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.crane_wing.name"; c.owner_id = "yi_sun_sin"; c.cost = 2
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.crane_wing.archetype"
	var e := EffRes.new()
...
static func _hansan_victory() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.hansan_victory.name"; c.owner_id = "yi_sun_sin"; c.cost = 3
	c.card_type = CardRes.CardType.ATTACK
...
static func _noryang_battle() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.noryang_battle.name"; c.owner_id = "yi_sun_sin"; c.cost = 3
	c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.DIVINE
	c.play_animation = "attack"
	c.archetype = "card.yi_sun_sin.noryang_battle.archetype"
	var e := EffRes.new()
...
static func _crane_wing_complete() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.crane_wing_complete.name"; c.owner_id = "yi_sun_sin"; c.cost = 2
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.DIVINE
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.crane_wing_complete.archetype"
	var e1 := EffRes.new()
...
static func _armor_upgrade() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.armor_upgrade.name"; c.owner_id = "yi_sun_sin"; c.cost = 1
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.COMMON
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.armor_upgrade.archetype"
	var e := EffRes.new()
	e.effect_type = EffRes.EffectType.BLOCK; e.value = 80; e.base_value = 80
	c.effects = [e]; return c
...
static func _iron_wall() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.iron_wall.name"; c.owner_id = "yi_sun_sin"; c.cost = 2
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.iron_wall.archetype"
	var e := EffRes.new()
...
static func _cannon_fire() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.cannon_fire.name"; c.owner_id = "yi_sun_sin"; c.cost = 2
	c.card_type = CardRes.CardType.ATTACK
	c.rarity = CardRes.Rarity.UNCOMMON
	c.play_animation = "attack"
...
static func _shield_guard() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.shield_guard.name"; c.owner_id = "yi_sun_sin"; c.cost = 0
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.COMMON
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.shield_guard.archetype"
	var e := EffRes.new()
	e.effect_type = EffRes.EffectType.BLOCK; e.value = 30; e.base_value = 30
	c.effects = [e]; return c
...
static func _counter_stance() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.counter_stance.name"; c.owner_id = "yi_sun_sin"; c.cost = 1
	c.card_type = CardRes.CardType.POWER
	c.rarity = CardRes.Rarity.RARE
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.counter_stance.archetype"
	var e := EffRes.new()
...
static func _fleet_rally() -> Resource:
	var c := CardRes.new()
	c.card_name = "card.yi_sun_sin.fleet_rally.name"; c.owner_id = "yi_sun_sin"; c.cost = 2
	c.card_type = CardRes.CardType.SKILL
	c.rarity = CardRes.Rarity.RARE
	c.play_animation = "idle"
	c.archetype = "card.yi_sun_sin.fleet_rally.archetype"
	var e1 := EffRes.new()
