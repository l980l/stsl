...
static func iwato_guardian(scene: PackedScene) -> Resource:
	var e := EnemyRes.new()
	e.enemy_name = "아마노이와토 수문장"; e.max_hp = 1900; e.character_scene = scene
	e.mythology = "japanese"
	var i1 := IntentRes.new()
	i1.action_type = IntentRes.ActionType.BUFF; i1.value = 70; i1.status_type = "block"
	var i2 := IntentRes.new()
	i2.action_type = IntentRes.ActionType.ATTACK; i2.value = 170; i2.target = IntentRes.TargetType.RANDOM
	var i3 := IntentRes.new()
	i3.action_type = IntentRes.ActionType.BUFF; i3.value = 50; i3.status_type = "block"
	var i4 := IntentRes.new()
	i4.action_type = IntentRes.ActionType.ATTACK; i4.value = 190; i4.target = IntentRes.TargetType.LOWEST_HP
...
static func susanoo_blade(scene: PackedScene) -> Resource:
	var e := EnemyRes.new()
	e.enemy_name = "스사노오의 검"; e.max_hp = 2000; e.character_scene = scene
	e.mythology = "japanese"
	var i1 := IntentRes.new()
	i1.action_type = IntentRes.ActionType.BUFF; i1.value = 3; i1.status_type = "strength"
	var i2 := IntentRes.new()
	i2.action_type = IntentRes.ActionType.ATTACK; i2.value = 190; i2.target = IntentRes.TargetType.LOWEST_HP
	var i3 := IntentRes.new()
...
static func blizzard_queen(scene: PackedScene) -> Resource:
	var e := EnemyRes.new()
	e.enemy_name = "유키온나의 여왕"; e.max_hp = 1800; e.character_scene = scene
	e.mythology = "japanese"
	var i1 := IntentRes.new()
	i1.action_type = IntentRes.ActionType.DEBUFF; i1.value = 3; i1.status_type = "weak"
	i1.target = IntentRes.TargetType.ALL
	var i2 := IntentRes.new()
	i2.action_type = IntentRes.ActionType.ATTACK; i2.value = 160; i2.target = IntentRes.TargetType.LOWEST_HP
	var i3 := IntentRes.new()
...
static func yamata_no_orochi(scene: PackedScene) -> Resource:
	var e := EnemyRes.new()
	e.enemy_name = "야마타노오로치"; e.max_hp = 4800; e.character_scene = scene
	e.mythology = "japanese"
	...
	p1i2.action_type = IntentRes.ActionType.ATTACK; p1i2.value = 190; p1i2.target = IntentRes.TargetType.RANDOM
	...
	p1i4.action_type = IntentRes.ActionType.ATTACK; p1i4.value = 180; p1i4.target = IntentRes.TargetType.ALL
	...
	p2i1.action_type = IntentRes.ActionType.ATTACK; p2i1.value = 230; p2i1.target = IntentRes.TargetType.LOWEST_HP
	var p2i2 := IntentRes.new()
	p2i2.action_type = IntentRes.ActionType.ATTACK; p2i2.value = 230; p2i2.target = IntentRes.TargetType.RANDOM
	...
	p2i4.action_type = IntentRes.ActionType.ATTACK; p2i4.value = 220; p2i4.target = IntentRes.TargetType.ALL
