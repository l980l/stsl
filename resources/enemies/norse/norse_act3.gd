...
static func valkyrie(scene: PackedScene) -> Resource:
	...
	i4.action_type = IntentRes.ActionType.ATTACK; i4.value = 250; i4.target = IntentRes.TargetType.LOWEST_HP
...
static func jormungandr(scene: PackedScene) -> Resource:
	...
	p0i2.target = IntentRes.TargetType.ALL
	var p0i3 := IntentRes.new()
	p0i3.action_type = IntentRes.ActionType.ATTACK; p0i3.value = 130; p0i3.target = IntentRes.TargetType.RANDOM
	# 페이즈1 (65% HP 전환)
	var p1i1 := IntentRes.new()
	...
	p1i3.action_type = IntentRes.ActionType.ATTACK; p1i3.value = 200; p1i3.target = IntentRes.TargetType.LOWEST_HP
	...
	p2i2.action_type = IntentRes.ActionType.ATTACK; p2i2.value = 80; p2i2.target = IntentRes.TargetType.ALL
	...
	p2i4.action_type = IntentRes.ActionType.ATTACK; p2i4.value = 250; p2i4.target = IntentRes.TargetType.ALL
	e.phase_patterns = [
		[p0i1, p0i2, p0i3],
		[p1i1, p1i2, p1i3],
		[p2i1, p2i2, p2i3, p2i4]
