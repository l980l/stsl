...
static func jormungandr_shard(scene: PackedScene) -> Resource:
	...
	var p0i1 := IntentRes.new()
	p0i1.action_type = IntentRes.ActionType.ATTACK; p0i1.value = 140; p0i1.target = IntentRes.TargetType.RANDOM; p0i1.damage_type = "bite_attack"
	var p0i2 := IntentRes.new()
	...
	p0i3.action_type = IntentRes.ActionType.ATTACK; p0i3.value = 140; p0i3.target = IntentRes.TargetType.RANDOM; p0i3.damage_type = "bite_attack"
	# 페이즈1: 전체 공격 + 강독
	var p1i1 := IntentRes.new()
	p1i1.action_type = IntentRes.ActionType.ATTACK; p1i1.value = 200; p1i1.target = IntentRes.TargetType.ALL; p1i1.damage_type = "bite_attack"
	var p1i2 := IntentRes.new()
...
static func jormungandr(scene: PackedScene) -> Resource:
	...
	# 페이즈0
	var p0i1 := IntentRes.new()
	p0i1.action_type = IntentRes.ActionType.ATTACK; p0i1.value = 130; p0i1.target = IntentRes.TargetType.RANDOM; p0i1.damage_type = "bite_attack"
	var p0i2 := IntentRes.new()
	p0i2.action_type = IntentRes.ActionType.DEBUFF; p0i2.status_type = "poison"; p0i2.value = 50
	p0i2.target = IntentRes.TargetType.ALL
	var p0i3 := IntentRes.new()
	p0i3.action_type = IntentRes.ActionType.ATTACK; p0i3.value = 130; p0i3.target = IntentRes.TargetType.RANDOM; p0i3.damage_type = "bite_attack"
	# 페이즈1 (65% HP 전환)
	var p1i1 := IntentRes.new()
	p1i1.action_type = IntentRes.ActionType.ATTACK; p1i1.value = 160; p1i1.target = IntentRes.TargetType.RANDOM; p1i1.damage_type = "bite_attack"
	var p1i2 := IntentRes.new()
	p1i2.action_type = IntentRes.ActionType.DEBUFF; p1i2.status_type = "poison"; p1i2.value = 60
	p1i2.target = IntentRes.TargetType.ALL
	var p1i3 := IntentRes.new()
	p1i3.action_type = IntentRes.ActionType.ATTACK; p1i3.value = 200; p1i3.target = IntentRes.TargetType.LOWEST_HP; p1i3.damage_type = "bite_attack"
	...
	p2i2.action_type = IntentRes.ActionType.ATTACK; p2i2.value = 80; p2i2.target = IntentRes.TargetType.ALL; p2i2.damage_type = "bite_attack"
	...
	p2i4.action_type = IntentRes.ActionType.ATTACK; p2i4.value = 250; p2i4.target = IntentRes.TargetType.ALL; p2i4.damage_type = "bite_attack"
