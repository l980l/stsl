...
static func sea_dragon_general(scene: PackedScene) -> Resource:
	...
	i1.action_type = IntentRes.ActionType.BUFF; i1.value = 2; i1.status_type = "strength"
	var i2 := IntentRes.new()
	i2.action_type = IntentRes.ActionType.ATTACK; i2.value = 160; i2.target = IntentRes.TargetType.RANDOM; i2.damage_type = "divine"
	var i3 := IntentRes.new()
	i3.action_type = IntentRes.ActionType.ATTACK; i3.value = 140; i3.target = IntentRes.TargetType.ALL; i3.damage_type = "divine"
	var i4 := IntentRes.new()
...
static func dongmyeong(scene: PackedScene) -> Resource:
	...
	var i4 := IntentRes.new()
	i4.action_type = IntentRes.ActionType.ATTACK; i4.value = 150; i4.target = IntentRes.TargetType.ALL; i4.damage_type = "divine"
...
static func samsin_grandma(scene: PackedScene) -> Resource:
	...
	p0i2.action_type = IntentRes.ActionType.ATTACK; p0i2.value = 140; p0i2.target = IntentRes.TargetType.LOWEST_HP; p0i2.damage_type = "divine"
	...
	p1i2.action_type = IntentRes.ActionType.ATTACK; p1i2.value = 180; p1i2.target = IntentRes.TargetType.ALL; p1i2.damage_type = "divine"
	...
	p2i3.action_type = IntentRes.ActionType.ATTACK; p2i3.value = 230; p2i3.target = IntentRes.TargetType.LOWEST_HP; p2i3.damage_type = "divine"
	...
	p2i5.action_type = IntentRes.ActionType.ATTACK; p2i5.value = 200; p2i5.target = IntentRes.TargetType.ALL; p2i5.damage_type = "divine"
