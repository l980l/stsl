...
const POISON_SGL  := 0.04
const POISON_ALL_V:= 0.08
...
const AVG_POISON        := 100  # POISON_BURST SINGLE 사용 시점 평균 독 수치
const AVG_POISON_ALL    := 150   # POISON_BURST ALL 사용 시점 (독살 빌드업 완성 기준)
const POISON_TICK       := 1    # 독 단순화 — 배수 없음 (value = 실제 피해)
