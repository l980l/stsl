...
const _VFX_CLAW_ATTACK := preload("res://scenes/vfx/claw_attack_gpu.gd")
...
const _VFX_DEATH_DISSOLVE := preload("res://scenes/vfx/death_dissolve_gpu.gd")
const _VFX_REVIVE_BLESSING := preload("res://scenes/vfx/revive_blessing_gpu.gd")
...
const _VFX_SLOW_DEBUFF := preload("res://scenes/vfx/slow_debuff_gpu.gd")
...
const _VFX_DISPEL := preload("res://scenes/vfx/dispel_gpu.gd")
const _VFX_FORM_CHANGE := preload("res://scenes/vfx/form_change_gpu.gd")
const _VFX_COUNTER := preload("res://scenes/vfx/counter_gpu.gd")
...
func _sfx_for_dtype(dtype: String) -> String:
	match dtype:
		...
		"claw_attack": return "claw_attack"
