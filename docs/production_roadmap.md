...
> 작성일: 2026-04-17 (최종 동기화: 2026-04-24 v4)
...
- ✅ 전역 디버그 단축키 11종 (PR #34~#35, #61)
  ...
  - ✅ Shift+M(몬스터 선택 전투) / Shift+B(영웅 HP 조정 다이얼로그) PR #73
...
> 최종 갱신: 2026-04-24 v6. PR #73 — 덱뷰어 완성·번역 인프라·카운터 개선 반영. 1145 테스트 통과.
