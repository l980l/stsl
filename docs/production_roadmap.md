...
> 작성일: 2026-04-17 (최종 동기화: 2026-04-22 v3)
> 기준: 챕터 1 완성 + 챕터 2 완성(한·중·일) + 영웅 6인 + 챕터 시스템 인프라 기준
> 범례: ✅ 완료 / 🔲 미완료 / 🔶 부분 완료
...
> 최종 갱신: 2026-04-22 v4. 챕터 2 완성(한·중·일) + 영웅 6인 + 디버그 11종 반영.
...
| 🟠 단기 | 카드 v2 확장 (영웅당 40장, M5) | 영웅 6인 카드 각 40장으로 확장 |
